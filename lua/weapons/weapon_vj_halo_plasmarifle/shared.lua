...
SWEP.WorldModel					= "models/cpthazama/halo3/weapons/plasma_rifle.mdl"
SWEP.AnimationType 				= "Rifle"
SWEP.HoldType 					= "ar2"
	-- NPC Settings ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.NPC_NextPrimaryFire 		= 0.135 -- Next time it can use primary fire
...
-- SWEP.NPC_TimeUntilFireExtraTimers = {0.2,0.4,0.6,0.8,1} -- Extra timers, which will make the gun fire again! | The seconds are counted after the self.NPC_TimeUntilFire!
